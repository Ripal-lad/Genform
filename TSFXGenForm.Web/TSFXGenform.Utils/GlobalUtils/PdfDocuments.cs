...
namespace TSFXGenform.Utils.GlobalUtils
{
    public class PdfDocuments
    {
        ...
        public static class CompatiblePdfReader
        {
            ...
            /// <returns></returns>
            public static byte[] Httpwebrequest(string pdfPath, int len)
            {
                try
                {
                    var request = (HttpWebRequest) WebRequest.Create(pdfPath);
            ...
            /// <returns></returns>
            public static PdfDocument Open(byte[] fileArray)
            {
                try
                {
            ...
            /// <returns></returns>
            public static PdfDocument Open(MemoryStream sourceStream)
            {
                PdfDocument outDoc;
        ...
        public void ExtractMetadata(string sourcePath)
        {
            try
            {
                var document = CompatiblePdfReader.Open(sourcePath);
