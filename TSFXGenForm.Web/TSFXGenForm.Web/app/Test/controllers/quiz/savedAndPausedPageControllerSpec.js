describe('Quiz-savedAndPausedPageControllerSpec', function () {
    var scope, $controllerConstructor, mockedEventService, mockedIntroPageService, $qservice, savedAndPausedPageController, mdDialog, defered, deferedSavedAndPaused, deferedTotalTimeTaken, deferedQuestionNo;
    beforeEach(angular.mock.module('app'));
    beforeEach(inject(function ($controller, $rootScope, $q, $mdDialog, savedAndPausedPageService, introPageSevice) {
    ...
    it("should calculate time and convert in minutes and seconds and timerString() have been called.", function () {
    ...
    it("should calculate time and convert in minutes and seconds.", function () {
        var totalAllottedTime = 804;
        var userTakenTime = 450;
        savedAndPausedPageController.calculateTime(totalAllottedTime, userTakenTime);
    ...
    it("should get total allotted time to complete the quiz and time taken by user.", function () {
        var minutes = 10;
        var seconds = 0;
    ...
    it("should prompt alert box if total allotted time is 0.", function () {
        var minutes = 10;
        var seconds = 0;
        var totalAllottedTime = new Object();
    ...
    it("should prompt alert box if user taken time is 0.", function () {
        var minutes = 10;
        var seconds = 0;
        var totalAllottedTime = new Object();
    ...
    it("should prompt alert box if user taken time and total allotted time are 0.", function () {
        var minutes = 10;
        var seconds = 0;
        var totalAllottedTime = new Object();
        totalAllottedTime["result"] = 0;
...
//# sourceMappingURL=savedAndPausedPageControllerSpec.js.map