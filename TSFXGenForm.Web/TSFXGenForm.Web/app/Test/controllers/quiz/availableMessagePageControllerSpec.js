describe('Quiz-availablePageControllerSpec', function () {
    var scope, $controllerConstructor, mockedEventService, $qservice, availableQuizMessageController, mdDialog, defered;
    ...
    it('should get Quiz details and bind it to UI.', function () {
        ...
        availableQuizMessageController.getQuizDetailsAndBindMessageToUi();
        scope.$root.$apply();
    ...
    it('should promp alert box if quiz details are not available.', function () {
        ...
        expect(availableQuizMessageController.getQuizDetailsAndBindMessageToUi).toBeDefined();
    });
    function initializeTest() {
        availableQuizMessageController = $controllerConstructor('AvailableQuizMessageController', {
            $scope: scope,
...
//# sourceMappingURL=availableMessagePageControllerSpec.js.map