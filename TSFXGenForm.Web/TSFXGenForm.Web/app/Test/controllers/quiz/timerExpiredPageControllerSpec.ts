describe('Quiz-timerExpiredPageControllerSpec', () => {
    var scope,
        $controllerConstructor: ng.IControllerService,
        mockedEventService,
        $qservice,
        interval,
        timerExpiredPageController,
        mockedResultPageServce,
        mdDialog,
        defered,
        deferedQuestionNo,
    ...
    it("should get quizSettingsdetails and bind quiz name", ()=> {
    ...
    it("should get quizSettingsdetails and prompt alert box if quiz setings details are null.", ()=> {
    ...
    it("should redirect to Result Page on click of View Result if resultPage is to be shown.", ()=> {
    ...
    it("should redirect to Result Page on click of View Result if result page is not be shown.", ()=> {
    ...
    it("should redirect to Result Page on click of Finish Quiz if result page is not be shown.", ()=> {
