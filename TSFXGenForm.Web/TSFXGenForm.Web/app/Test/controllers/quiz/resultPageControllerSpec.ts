describe('Quiz-resultPageControllerSpec', () => {
    var scope,
    ...
    it("should return list of result for individual questions and bind it to UI.", ()=> {
    ...
    it("should return state averages and relative rank and bind it to UI.", ()=> {
    ...
    it('should redirect to QuizManagerPage.', ()=> {
