describe('Quiz-availablePageControllerSpec', () => {
    var scope,
        $controllerConstructor: ng.IControllerService,
        mockedEventService,
        $qservice,
        availableQuizMessageController,
        mdDialog,
        defered;
    ...
    it('should get Quiz details and bind it to UI.', ()=> {
    ...
    //Should get Quiz details and bind it to UI
    it('should promp alert box if quiz details are not available.', ()=> {
