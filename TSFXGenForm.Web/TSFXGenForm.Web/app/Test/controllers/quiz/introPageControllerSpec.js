describe('Quiz-introPageControllerSpec', function () {
    var scope, $controllerConstructor, mockedEventService, $qservice, introPageController, sce, mdDialog, defered, deferedQuizName, deferedAvailableQuiz, deferedDetailsofIntroPage, deferedcheckUrl, deferedDetailsOnLoad, deferedQuizPage;
    beforeEach(angular.mock.module('app'));
    beforeEach(inject(function ($controller, $rootScope, $sce, $q, $mdDialog, introPageSevice) {
        sce = $sce;
    ...
    it('Should get Quiz name and bind to UI.', inject(function () {
    ...
    it('should call method "checkQuizIsAvailableorNotAndInitializeQuiz" if Quiz is not available.', inject(function () {
    ...
    it('Should bind message details to page.', inject(function () {
        var quiz = new Object();
        quiz["Id"] = 7;
    ...
    it('Should check whether Quiz has been resumed or not and bind "Resume Quiz" to button.', inject(function () {
    ...
    it('Should check whether Quiz has been resumed or not and bind "Begin Quiz" to button.', inject(function () {
        var quizResumed = new Object();
    ...
    it('Clicking on Begin Quiz button it should Resume quiz.', inject(function () {
    ...
    it('Clicking on Resume Quiz button check if Question are not answered then resume quiz.', inject(function () {
        var quizPageQuestion = new Object();
        quizPageQuestion["QuestionNumber"] = 2;
        quizPageQuestion["QuestionIds"] = "5,6,7";
        var quizPageDetails = new Object();
    ...
    it('Clicking on Resume Quiz button check if Question are answered then resume from the self scoring intro page.', inject(function () {
        var quizPageDetails = new Object();
    ...
    it('Clicking on Resume Quiz button check if Question are answered if there is an error to get check for the self scoring intro page then prompt dialog box.', inject(function () {
        var quizPageDetails = new Object();
        quizPageDetails["result"] = "null";
        scope.beginQuizName = "Resume Quiz";
        spyOn(mockedEventService, "getQuizPageQuestionToResumeQuiz").and.returnValue(deferedQuizPage.promise);
    ...
    it('Should call myQuizzes.', inject(function () {
        scope.myQuizzes();
        expect(scope.myQuizzes).toBeDefined();
    }));
...
//# sourceMappingURL=introPageControllerSpec.js.map