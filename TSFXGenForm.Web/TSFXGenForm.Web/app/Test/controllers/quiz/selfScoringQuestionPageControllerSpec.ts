describe('Quiz-selfScoringQuestionPageControllerSpec', () => {
    var scope,
        $controllerConstructor: ng.IControllerService,
        mockedEventService,
        $qservice,
        defered,
        mockedResultPageService,
        deferedQuizSettings,
        deferedQuizPage,
        deferedQuizQuestion,
        mdDialog,
        sce,
        selfScoringQuestionPageController;
    ...
    beforeEach(inject(($controller: ng.IControllerService,
        ...
        $q: ng.IQService,
        $mdDialog,
        selfScoringQuestionPageService,
        resultPageService
        ) => {
    ...
    it("should get questions details.", () => {
    ...
    it("should prompt alert box if question details contain null value.", () => {
    ...
    it("should bind Question details to page .", () => {
    ...
    it("should bind Question details to page if user has self scored their answers and clicked previous.", () => {
        var quizPageAndQuestionDetails = new Object();
    ...
    //bind questions details to page.
    it("should validate user score if user has scored.", () => {
    ...
    //bind questions details to page.
    it("should validate user score if user has not self scored yet.", () => {
    ...
    it("should promp alert message if user has clicked next button without self scoring.", () => {
    ...
    it("should load next question if user has clicked next button.", () => {
    ...
    it("should load result page if all questions have been self scored and user has clicked next button.", () => {
    ...
    it("should load previous question clicked previous button.", () => {
    ...
    //bind load self scoring intro page if user clicks previous button on first question.
    it("should load self scoring intro page if user has clicked previous button from the 1st question.", () => {
    ...
    it("should check whether to show ResultPage or not and redirect to Result Page.", () => {
    ...
    it("should check whether to show ResultPage or not and redirect to EndMessagePage.", () => {
    ...
    it("should check whether the timer was expired for short answer questions and redirect it to next question.", () => {
        ...
        spyOn(selfScoringQuestionPageController, 'validateUserScore').and.callFake(() => {
            return false;
        });
        var quizPageAndQuestionDetails = new Object();
    ...
    //check for the previous button.
    it("Previous route controller should be defined.", () => {
    ...
    function initializeTest() {
        selfScoringQuestionPageController = $controllerConstructor('SelfScoringQuestionPageController', {
            ...
            $sce: sce,
            $mdDialog: mdDialog,
            prevRoutePromiseGetter: () => { return defered.promise; },
