...
describe('resourceNotesControllerSpec', () => {
    var scope,
        $controllerConstructor: ng.IControllerService,
        mockedEventService,
        $qservice,
        resourceNotesController,
        mdDialog,
        defered,
        deferedSvgFile;
    ...
    it('multipleFileData should not be null', inject(()=> {
    ...
    it('should get selected resource details for single pdf file.', inject(()=> {
    ...
    it('should get selected resource details for multiple pdf file.', inject(()=> {
    ...
    it('should bind svg file to UI.', inject(()=> {
    ...
    it('should prompt alert box if svg file does not exist.', inject(()=> {
    ...
    it('should prompt alert box if xml file does not have any data.', inject(()=> {
