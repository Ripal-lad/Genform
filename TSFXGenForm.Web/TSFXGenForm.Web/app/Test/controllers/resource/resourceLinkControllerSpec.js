...
describe('resourceLinkControllerSpec', function () {
    var scope, $controllerConstructor, mockedEventService, $qservice, resourceLinkController, defered;
    beforeEach(angular.mock.module('app'));
    beforeEach(inject(function ($controller, $rootScope, $q, resourceLinkService) {
    ...
    it('Should get selected resource and bind it to UI.', function () {
...
//# sourceMappingURL=resourceLinkControllerSpec.js.map