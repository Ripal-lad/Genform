describe("resourceLinkServiceSpec", function () {
    var httpBackend, _resourceLinkService, hiddenCode;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function (resourceLinkService, $httpBackend) {
    ...
    it("should return selected resource", function () {
        ...
        _resourceLinkService.createResourceLinkPreview(hiddenCode).then(function (data) {
...
//# sourceMappingURL=resourceLinkServiceSpec.js.map