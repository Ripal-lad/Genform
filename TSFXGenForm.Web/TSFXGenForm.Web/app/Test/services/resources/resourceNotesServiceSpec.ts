describe("resourceNotesServiceSpec", ()=> {
    var httpBackend, _resourceNotesService, hiddenCode;

    beforeEach(angular.mock.module("app"));

    beforeEach(inject((resourceNotesService, $httpBackend) => {
    ...
    it("should return selected resource", ()=> {
        ...
        _resourceNotesService.getResourceDetailsForHiddenCodePassed(hiddenCode).then((data)=> {
    ...
    it("should return path for svg files and pdf files", ()=> {
        ...
        _resourceNotesService.createResourcesNotesPreview(hiddenCode, svgFileName).then((data)=> {
