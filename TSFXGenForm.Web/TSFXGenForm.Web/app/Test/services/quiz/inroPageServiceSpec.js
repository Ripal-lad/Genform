describe("Quiz-introPageServiceSpec", function () {
    var httpBackend, _introPageService, hiddenCode;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function (introPageSevice, $httpBackend) {
        httpBackend = $httpBackend;
        _introPageService = introPageSevice;
        hiddenCode = "wmbhwquq";
    }));
    it("should initiate data into QuizDefine.", function () {
        ...
        _introPageService.initializeQuizDefineOnPageLoad(hiddenCode).then(function (data) {
    ...
    it("should return Quiz Name.", function () {
        ...
        _introPageService.getCurrentQuizName(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
    ...
    //get name of the Quiz.
    it("should check available date for the Quiz.", function () {
        ...
        _introPageService.checkQuizIsAvailableOrNot(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
            expect(data.result).toEqual(true);
        });
        httpBackend.flush();
    ...
    it("should return Quiz details.", function () {
        ...
        _introPageService.getDetailsForIntroPage(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should check whether user has paused the quiz or not.", function () {
        ...
        _introPageService.checkIfQuizQuestionPageIsSaveAndPausedByUser(hiddenCode, userId).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should check if Quiz has been answered but self scoring is remained.", function () {
        var response = new Object();
        response["result"] = true;
        var userId = 1;
        ...
        _introPageService.checkIfSelfScoringQuestionIsSaveAndPausedByUser(hiddenCode, userId).then(function (data) {
            expect(data).not.toBeNull();
            expect(data.result).toEqual(true);
        });
        httpBackend.flush();
    ...
    it("should get question no of the first question to be displayed.", function () {
        ...
        _introPageService.getFirstQuestionNumberToLoadOnQuestionPage(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
        });
        httpBackend.flush();
    });
    ...
    it("should return total count of self scoring questions.", function () {
        ...
        _introPageService.getSelfScoringQuestionsCount(hiddenCode, resultSummaryId).then(function (data) {
            expect(data).not.toBeNull();
            expect(data.result).toEqual(2);
        });
        httpBackend.flush();
    ...
    //get total number of short answer quiz questions and check for the existence of PageType 6..
    it("should return Question details to resume quiz.", function () {
        var quizPageQuestion = new Object();
        quizPageQuestion["QuestionNumber"] = 2;
        quizPageQuestion["QuestionIds"] = "5,6,7";
        ...
        _introPageService.getQuizPageQuestionToResumeQuiz(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
        });
        httpBackend.flush();
    });
});
//# sourceMappingURL=inroPageServiceSpec.js.map