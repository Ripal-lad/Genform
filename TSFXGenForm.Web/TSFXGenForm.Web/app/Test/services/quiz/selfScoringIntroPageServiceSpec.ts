describe("Quiz-selfScoringIntroPageServiceSpec", () => {
    var httpBackend, _selfScoringIntroPageService, hiddenCode;

    beforeEach(angular.mock.module("app"));

    beforeEach(inject((selfScoringIntroPageService, $httpBackend) => {
    ...
    it("should return Quiz Name.", ()=> {
        ...
        _selfScoringIntroPageService.getCurrentQuizName(hiddenCode).then((data)=> {
    ...
    it("should return total time taken by user to complete quiz.", ()=> {
        ...
        _selfScoringIntroPageService.getTotalTimeTakenByUser(hiddenCode).then((data) =>{
            expect(data).not.toBeNull();
    ...
    it("should return question number for selfscoring questionpPage.", () =>{
        ...
        _selfScoringIntroPageService.getFirstSelfScoringQuestionNo(hiddenCode, userId).then((data) =>{
            expect(data).not.toBeNull();
