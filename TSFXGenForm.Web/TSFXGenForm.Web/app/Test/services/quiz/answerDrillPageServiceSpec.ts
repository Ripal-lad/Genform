describe("Quiz-answerDrillPageServiceSpec", () => {
    var httpBackend, _answerDrillPageService, hiddenCode;

    beforeEach(angular.mock.module("app"));

    beforeEach(inject((answerDrillPageService, $httpBackend) => {
    ...
    it("should return Quiz Name.", ()=> {
        ...
        _answerDrillPageService.getCurrentQuizName(hiddenCode).then((data)=> {
    ...
    it("should return total number of quiz questions.", ()=> {
        ...
        _answerDrillPageService.getTotalNumberOfQuestions(hiddenCode).then((data) =>{
            expect(data).not.toBeNull();
    ...
    it("should return QuizQuestion QuestionType 2 i.e. short answer questions.", () =>{
    ...
    it("should return QuizQuestion for QuestionType 1 i.e. multiple choice answers.", () =>{
