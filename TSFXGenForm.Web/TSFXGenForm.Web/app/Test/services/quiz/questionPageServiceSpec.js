describe("Quiz-questionPageServiceSpec", function () {
    var httpBackend, _questionPageService, hiddenCode;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function (questionPageService, $httpBackend) {
    ...
    it("should return total number of quiz questions.", function () {
        ...
        _questionPageService.getTotalNumberOfQuestions(hiddenCode).then(function (data) {
    ...
    //get total number of quiz questions.
    it("should initialize data into quizresultsummary andn quizcompilation table.", function () {
        ...
        _questionPageService.initializeQuizResultSummaryAndQuizCompilation(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return Total allotted time for Quiz.", function () {
        ...
        _questionPageService.getTotalAllottedTimeForQuiz(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return QuizSettings.", function () {
        ...
        _questionPageService.getQuizSettingDetails(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return state averages and relative rank.", function () {
        ...
        _questionPageService.getDetailsOnResultsPageLoad(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
        });
        httpBackend.flush();
    });
    //get total number of short answer quiz questions.
    it("should check whether user has paused the quiz or not and return quizresultsummaryid.", function () {
        var quizResultSummaryId = new Object();
        ...
        _questionPageService.checkIfQuizQuestionPageIsSaveAndPausedByUser(hiddenCode, userId).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return Quiz Page ,Quiz Question and Quiz Result details on page load.", function () {
        ...
        _questionPageService.getQuestionAndPageDetailsForQuestionPage(hiddenCode, questionNumber, userId).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return next QuizPageQuestion when next clicked.", function () {
        ...
        _questionPageService.getNextQuizPageOfQuiz(userAnswersAndPageDetails).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return QuizPageQuestion for Previous page.", function () {
        var quizPageQuestion = new Object();
        quizPageQuestion["QuestionNumber"] = 2;
        quizPageQuestion["QuestionIds"] = "5,6,7";
        ...
        _questionPageService.getPreviousQuizPageOfQuiz(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return total time taken by user to complete quiz.", function () {
        ...
        _questionPageService.getTotalTimeTakenByUser(hiddenCode, userId, quizResultSummaryId).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return total count of self scoring questions.", function () {
        var response = new Object();
        response["result"] = 2;
        ...
        _questionPageService.getSelfScoringQuestionsCount(hiddenCode, resultSummaryId).then(function (data) {
            expect(data).not.toBeNull();
            expect(data.result).toEqual(2);
        });
        httpBackend.flush();
    ...
    it("should set timer value.", function () {
        var response = new Object();
        response["result"] = 500;
        ...
        _questionPageService.setAndGetRemainingtime(timeRemaining, true).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should get timer value.", function () {
        var response = new Object();
        response["result"] = 500;
        var timeRemaining = 0;
        httpBackend.expectGET(apiPaths.setAndGetRemainingtime + "?setValue=" + false + "&timeRemaining=" + timeRemaining).respond(response);
        _questionPageService.setAndGetRemainingtime(timeRemaining, false).then(function (data) {
            expect(data).not.toBeNull();
            expect(data.result).toEqual(500);
        });
        httpBackend.flush();
    ...
    //set timer value in the static variable.
    it("should set question no to check whether the hide previous button or not.", function () {
        var response = new Object();
        response["result"] = 1;
        var questionNo = 1;
        ...
        _questionPageService.setValueOfFirstQuestionToHidePreviousButton(questionNo, true).then(function (data) {
            expect(data).not.toBeNull();
            expect(data.result).toEqual(1);
        });
        httpBackend.flush();
    ...
    //Get timer value in the static variable.
    it("should get question no to check whether the hide previous button or not.", function () {
        var response = new Object();
        response["result"] = 1;
        var questionNo = 1;
        ...
        _questionPageService.setValueOfFirstQuestionToHidePreviousButton(questionNo, false).then(function (data) {
...
//# sourceMappingURL=questionPageServiceSpec.js.map