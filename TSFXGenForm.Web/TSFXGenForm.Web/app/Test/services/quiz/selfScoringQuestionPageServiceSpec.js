describe("Quiz-selfScoringQuestionPageServiceSpec", function () {
    var httpBackend, _selfScoringQuestionPageService, hiddenCode;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function (selfScoringQuestionPageService, $httpBackend) {
    ...
    it("should return Quiz Name.", function () {
        ...
        _selfScoringQuestionPageService.getCurrentQuizName(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
        });
        httpBackend.flush();
    });
    //Get question details
    it("should return single Quiz Question", function () {
        ...
        _selfScoringQuestionPageService.getQuestionForSelfScoringQuestionPage(hiddenCode, userId, quizQuestionNo).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return list of Question", function () {
        var quizPageAndQuestionDetailsList = [];
        var quizPageAndQuestionDetails = new Object();
        ...
        _selfScoringQuestionPageService.getQuestionForSelfScoringQuestionPage(hiddenCode).then(function (data) {
    ...
    it("should return next Quiz Page details.", function () {
        var quizPageAndQuestionDetails = new Object();
        ...
        _selfScoringQuestionPageService.getNextQuizPageOfSelfScoringQuestion(quizPageAndQuestionDetailsList).then(function (data) {
            expect(data).not.toBeNull();
    ...
    //Get next page details
    it("should return previous Quiz Page details.", function () {
        var quetionId = [];
        quetionId.push(6, 18);
        var quizPageQuestion = new Object();
        ...
        _selfScoringQuestionPageService.getPreviousQuizPageOfSelfScoringQuestion(hiddenCode, quizQuestionNo).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return total count of self scoring questions.", function () {
        ...
        _selfScoringQuestionPageService.getSelfScoringQuestionsCount(hiddenCode, resultSummaryId).then(function (data) {
            expect(data).not.toBeNull();
    ...
    //get total number of short answer quiz questions.
    it("should check whether user has paused the quiz or not.", function () {
        ...
        _selfScoringQuestionPageService.checkIfQuizQuestionPageIsSaveAndPausedByUser().then(function (data) {
            expect(data).not.toBeNull();
            expect(data.result).toEqual(2);
        });
        httpBackend.flush();
    ...
    it("should set question no to check whether the hide previous button or not.", function () {
        ...
        _selfScoringQuestionPageService.setValueOfFirstQuestionToHidePreviousButton(questionNo, setValue).then(function (data) {
            expect(data).not.toBeNull();
...
//# sourceMappingURL=selfScoringQuestionPageServiceSpec.js.map