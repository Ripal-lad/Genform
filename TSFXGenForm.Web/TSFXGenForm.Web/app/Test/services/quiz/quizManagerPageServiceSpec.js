describe("quizManagerPageServiceSpec", function () {
    var httpBackend, _quizManagerPageService, hiddenCode;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function (quizManagerPageService, $httpBackend) {
        httpBackend = $httpBackend;
        _quizManagerPageService = quizManagerPageService;
        hiddenCode = "wmbhwquq";
    }));
    it("should return QuizManagerPage details if user has attempted multiple quiz earlier.", function () {
        var quizManager = [];
        ...
        _quizManagerPageService.getQuizDetailListForQuizManagerPage(hiddenCode, userId).then(function (data) {
    ...
    it("should return QuizManagerPage details if user has not given any of the quiz yet.", function () {
        var quizManager = [];
        var quizManagerDetailList = new Object();
...
//# sourceMappingURL=quizManagerPageServiceSpec.js.map