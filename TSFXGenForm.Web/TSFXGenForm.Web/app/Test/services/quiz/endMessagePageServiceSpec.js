describe("Quiz-endMessagePageServiceSpec", function () {
    var httpBackend, _endMessagePageService, hiddenCode;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function (endMessagePageService, $httpBackend) {
        httpBackend = $httpBackend;
        _endMessagePageService = endMessagePageService;
        hiddenCode = "yv2xdir3";
    }));
    it("should return Quiz details to bind End EndMessage on UI.", function () {
        var quiz = new Object();
        quiz["Id"] = 7;
        ...
        _endMessagePageService.getQuizSettingDetails(hiddenCode).then(function (data) {
...
//# sourceMappingURL=endMessagePageServiceSpec.js.map