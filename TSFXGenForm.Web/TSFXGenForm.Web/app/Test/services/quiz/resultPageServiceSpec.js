describe("Quiz-resultPageServiceSpec", function () {
    var httpBackend, _resultPageService, hiddenCode;
    beforeEach(angular.mock.module("app"));
    beforeEach(inject(function (resultPageService, $httpBackend) {
    ...
    it("should return QuizSettings.", function () {
        ...
        _resultPageService.getQuizSettingDetails(hiddenCode).then(function (data) {
    ...
    it("should return list of result for individual questions.", function () {
        ...
        _resultPageService.getResultsPageListOnPageLoad(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
    ...
    it("should return state averages and relative rank.", function () {
        ...
        _resultPageService.getDetailsOnResultsPageLoad(hiddenCode).then(function (data) {
            expect(data).not.toBeNull();
        });
        httpBackend.flush();
    });
});
//# sourceMappingURL=resultPageServiceSpec.js.map